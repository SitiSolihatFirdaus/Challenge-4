...
const style = {
    ...
    button2: `my-4 px-10 w-2/12 border p-2 bg-cyan-600 rounded-md text-white`,
}
...
function ToDoEdit() {
    ...
    useEffect(() => {
        axios.get(`https://fake-api-coba.herokuapp.com/todos/${id}`).then((res) => {
    ...
    function Update(e) {
        e.preventDefault() 
            axios.put(`https://fake-api-coba.herokuapp.com/todos/${id}`, data)
            .then(navigate("/"));
    }
    ...
    return (
        <div className={style.bg}>
                ...
                <div className={style.container}>
                    ...
                    <button 
                    onClick={Update} 
                    className={style.button}>Submit</button>
                </div>
